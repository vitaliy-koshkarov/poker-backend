...
public class JoinPlayerActionHandler implements PlayerActionHandler {
    ...
    public void handleAction(GameEngine gameEngine, Game game, Player actionInitiatorPlayer, List<Player> players) {
        ...
        var thPlayer = new THPlayer(playerId, actionInitiatorPlayer.getNickname(), game.getBuyIn());
...
//        player updates in SUBSCRIBE Controller method
        log.info("Player id {} {} game id {}", actionInitiatorPlayer.getId(), PlayerActions.JOIN_GAME, game.getId());
    }
}
